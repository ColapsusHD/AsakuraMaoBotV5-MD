...
await m.reply(`*@${who.split`@`[0]}* recibió una advertencia en este grupo!\nMotivo: ${motivo}\n*Advertencias: ${user.warn}/6*`, null, { mentions: [who] })
if (user.warn >= 6) {
user.warn = 0
await m.reply(`❀ ¡Te lo advertí varias veces!\n*@${who.split`@`[0]}* superó las *6* advertencias, ahora será eliminado/a.`, null, { mentions: [who] })
